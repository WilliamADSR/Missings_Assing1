...
The matter of interest for this assignment will be the impact that incomplete data (**observed data**) have on our inferences compared to the inferences we make with complete data (**true data**). To investigate the effect that missing values have on model inferences, we will build a random multiple regression model. 
  ...
  Thirdly, we start by inspecting the missing values. Then, we try to find out where the missing values occur. In \@ref(fig:misspat) we begin by giving a global overview of the missingness. Then, in \@ref(fig:mnar-plot) we compare the distributions for the observed data and the missing values.             Lastly, we perform t-tests on the variables containing missing values to check the type of missingness, either MNAR, MAR, or MCAR. We also provide plots here to visualize where the missing values occur.
...
```{r mar-weight, echo=FALSE, fig.show='asis', out.width = "33%", fig.cap = "Looking whether the missingness of weight is MAR", fig.subcap=c('Sex', 'Smoke', 'Intensity', 'Rest', 'Age', 'Height', 'Bmi', 'Active'), fig.ncol = 3, fig.align='center'}
...
```{r mar-height, echo=FALSE, fig.show='hold', out.width = "33%", fig.cap = "Looking whether the missingness of height is MAR", fig.subcap=c('Sex', 'Smoke', 'Intensity', 'Rest', 'Age', 'Bmi', 'Active'), fig.ncol = 3, fig.align='center'}
...
```{r mar-active, echo=FALSE, out.width = "33%", fig.cap = "Looking whether the missingness of active is MAR", fig.subcap = c('Sex', 'Smoke', 'Intensity', 'Rest', 'Age', 'Height', 'Bmi', 'Weight'), fig.ncol = 3, fig.align='center'}
...
```{r mar-bmi, echo=FALSE, fig.show='hold', out.width = "33%", fig.cap = "Looking whether the missingness of bmi is MAR", fig.subcap=c('Sex', 'Smoke', 'Intensity', 'Rest', 'Age', 'Height', 'Active'), fig.ncol = 3, fig.align='center'}
...
```{r mar-smoke, echo=FALSE, fig.show='hold', out.width = "33%", fig.cap = "Looking whether the missingness of smoking is MAR", fig.subcap=c('Age', 'Intensity', 'Rest', 'Age', 'Height', 'Bmi', 'Weight'), fig.ncol = 3, fig.align='center'}
...
By default, `mice` will produce `r m` imputations and 5 iterations. **Say here something about the imputations and iterations (what do they do and why do we use them?)**   
