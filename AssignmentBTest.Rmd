...
```{r mar-smoke1, echo=FALSE, fig.show='hold', out.width = "33%", fig.cap = "Looking whether the missingness of smoking is MAR", fig.subcap=c('Age', 'Intensity', 'Rest', 'Age'), fig.ncol = 3, fig.align='center'}
...
```{r mar-smoke2, echo=FALSE, fig.show='hold', out.width = "33%", fig.cap = "Looking whether the missingness of smoking is MAR", fig.subcap=c('Height', 'Bmi', 'Weight'), fig.ncol = 3, fig.align='center'}
marSmoke5
marSmoke6
marSmoke7
