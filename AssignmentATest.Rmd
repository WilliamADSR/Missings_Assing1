...
tab_mnar <- data.frame(
  ...
  meanTrue <- c("73.17out", "172.83", "23.95", "93.95"),
...
All results are insignificant, hence weight is not missing at random. 
