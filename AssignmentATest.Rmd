...
Thirldy we start by inspecting the missing values. We try to find out where the missings occur. In \@ref(fig:misspat) we start by giving a global overview of the missings.
