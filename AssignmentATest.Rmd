...
For the first model we used the observed data, and for the second model we used the true data. When examining Table 2.5 several differences in estimates and p-values \@ref(fig:reg)
