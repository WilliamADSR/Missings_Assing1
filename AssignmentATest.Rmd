...
tab_tW <- data.frame(
  ...
  tVal <- c(tOutW4, tOutW5, tOutW6, tOutW7, tOutW8),
  pVal <- c(pOutW4, pOutW5, pOutW6, pOutW7, pOutW8)
)
...
tab_tH <- data.frame(
  ...
  tVal <- c(tOutH4, tOutH5, tOutH6, tOutH7),
  pVal <- c(pOutH4, pOutH5, pOutH6, pOutH7)
)
...
tab_tA <- data.frame(
  ...
  tVal <- c(tOutA4, tOutA5, tOutA6, tOutA7, tOutA8),
  pVal <- c(pOutA4, pOutA5, pOutA6, pOutA7, pOutA8)
)


kbl(tab_tH, caption = "Difference in means of missingness of active",
    col.names = c("variables", "$M_{Obs}$", "$M_{True}$", "$t$", "$p$")
    ) %>% 
  kable_classic(full_width = F, html_font = "Cambria")
...
tab_tB <- data.frame(
  ...
  tVal <- c(tOutB4, tOutB5, tOutB6, tOutB7),
  pVal <- c(pOutB4, pOutB5, pOutB6, pOutB7)
)
